        ...
        <div class="flex justify-between items-center">
            ...
            @else
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('register') }}" class="bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-700">ثبت‌نام</a>
                </div>
            @endauth
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-2">
        <div class="bg-green-100 text-green-800 p-3 rounded notification">
            <div class="flex items-center justify-between">
                ...
                <button onclick="this.parentElement.parentElement.style.display='none'" class="text-green-600">✕</button>
            </div>
        </div>
    </div>
@endif
    ...
    <div class="max-w-7xl mx-auto px-4 py-2">
        <div class="bg-red-100 text-red-800 p-3 rounded notification">
            <div class="flex items-center justify-between">
                ...
                <button onclick="this.parentElement.parentElement.style.display='none'" class="text-red-600">✕</button>
            </div>
        </div>
    </div>
@endif
    ...
    <div class="max-w-7xl mx-auto px-4 py-2">
        <div class="bg-yellow-100 text-yellow-800 p-3 rounded notification">
            <div class="flex items-center justify-between">
                ...
                <button onclick="this.parentElement.parentElement.style.display='none'" class="text-yellow-600">✕</button>
            </div>
        </div>
    </div>
@endif
