...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-lg p-4">
            ...
            <div class="mt-2 text-xs text-gray-500 border-t pt-2">
                <div>🔍 Debug: Smart Start = {{ $nextSmartId }}, Display Next = {{ $displayNextId }}</div>
        ...
        <form method="POST" action="{{ route('configs.update', $config) }}" class="space-y-6">
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    ...
                    <ul class="text-yellow-700 text-sm space-y-1">
                        ...
                        <li>• اگر "صفحه شروع" را خالی بگذارید، از ID <strong>{{ number_format($displayNextId) }}</strong> ادامه می‌یابد</li>
                        <li>• اگر عدد مشخصی وارد کنید، از همان ID شروع می‌شود</li>
                        <li>• تغییر این تنظیمات بر روی اجرای بعدی تأثیر می‌گذارد</li>
                        <li>• سیستم خودکار source ID های ناموفق را 3 بار تلاش می‌کند</li>
                    </ul>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            خالی = از ID {{ number_format($displayNextId) }} ادامه
                        </p>
                        @error('start_page')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="text-sm text-gray-700 space-y-1" id="config-preview">
                    ...
                    <div>🔢 <strong>شروع از ID:</strong> <span id="preview-start">{{ $displayNextId }} (ادامه هوشمند)</span></div>
    ...
    <script>
        ...
        function updatePreview() {
            ...
            // شروع
            let startText;
            if (startPage && startPage.trim() !== '') {
                startText = `${number_format(startPage)} (مشخص شده)`;
            } else {
